...
namespace Simple_School_Management.Controllers
{
    public class RegistrationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,fName,lName,nic,courseId,batchId,mobile")] Registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,fName,lName,nic,courseId,batchId,mobile")] Registration registration)
        {
            if (ModelState.IsValid)
            {
